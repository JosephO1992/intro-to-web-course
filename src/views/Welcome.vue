<template>
    <page-layout>
      ...
      <p class="mb-4">
        Hi there! 👋🏻 My name is Joe O'Reilly, I'm a Software Developer. I've
        been developing in my own time for a while now, and in the last few
        months it's become my full time job.
      </p>
      <p class="mb-4">
        I'd like to share my passion with you, and hopefully you can learn
        something new and exciting.
      </p>

      <p class="mb-4">🙏🏻 Welcome to your introduction into Web Development.</p>

      <p class="mb-4">The aim of the course is to:</p>
      <ul class="flex flex-col ml-8" v-for="(aim, index) in aims" :key="index">
      ...
      <ul class="flex flex-col ml-8">
        ...
        >
          <p class="flex flex-shrink-0">{{ step.step }}:</p>
          <p class="ml-4">{{ step.instruction }}</p>
        </li>
      </ul>
